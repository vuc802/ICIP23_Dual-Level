...
__C.DATASET.CITYSCAPES_DIR = '/shared/tinatina_data/cityscape' 
#SDC Augmented Cityscapes Dir Location
__C.DATASET.CITYSCAPES_AUG_DIR = ''
#Mapillary Dataset Dir Location
__C.DATASET.MAPILLARY_DIR = '/shared/tinatina_data/mapillary' 
#GTAV, BDD100K Dataset Dir Location
__C.DATASET.GTAV_DIR = '/shared/tinatina_data/GTA5'
__C.DATASET.BDD_DIR = '/shared/tinatina_data/bdd100k'
# __C.DATASET.ACDC_DIR = '/ssd/yyzhao/data/ACDC' 
#Synthia Dataset Dir Location
__C.DATASET.SYNTHIA_DIR = '/shared/tinatina_data/synthia' 
