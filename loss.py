...
#         gram = torch.bmm(x, x.transpose(1, 2)).div(H*W-1) + (eps * eye)  # C X C / HW
#         return gram
...
#     """  
#     f1 = torch.flatten(gram_matrix(f1))
#     f2 = torch.flatten(gram_matrix(f2))
#     feat_diff = F.mse_loss(f1, f2, reduction='none') 
#     return torch.mean(feat_diff)
