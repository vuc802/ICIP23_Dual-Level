...
def load_weights(net, optimizer, optimizer_ada, scheduler_net, scheduler_adain, snapshot_file, restore_optimizer_bool=False):
    """
    Load weights from snapshot file
    """
    logging.info("Loading weights from model %s", snapshot_file)
    net, optimizer, scheduler, epoch, mean_iu = restore_snapshot(net, optimizer, optimizer_ada, scheduler_net, scheduler_adain, snapshot_file,
            restore_optimizer_bool)
    return epoch, mean_iu


def restore_snapshot(net, optimizer, optimizer_ada, scheduler, scheduler_adain, snapshot, restore_optimizer_bool):
    """
